...
export const Home = () => {
  ...
  const handleAccessibilityOption = (option) => {
    ...
    const menu_optionlist = document.querySelectorAll(
      ".header_banner .nav-item a"
    );
    const title = document.querySelector(".big_logo h1");
    const home_text = document.querySelectorAll(".home_text p");
    const button_home = document.querySelector(
      ".button-container-home .home_button"
    );
    const button_home_text = document.querySelector(
      ".button-container-home .home_button a"
    );
    const footer_text = document.querySelector(
    ...
    <div className="home_container">
      ...
      <div className="body_home">
        ...
        <div className="home_text">
          ...
          <p>
            Established in 1992 in Taiwan, we strive to create high quality
      ...
      <div className="footer_container">
        <div className="footer_text">
          <p>Made for CSCE 331 Fall 2023</p>
        </div>
      </div>
    </div>
  );
